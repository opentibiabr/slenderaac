...
<style>
	...
	:global(.classic-native-content)
		.catalog-details--plain.catalog-details--illustrated
		td {
		padding-right: 66px;
	}
	:global(.classic-native-content) .catalog-details--plain {
		border: 0;
		border-collapse: separate;
		border-spacing: 2px;
	}
	:global(.classic-native-content) .catalog-details--plain :is(th, td) {
		padding: 1px;
		border: 0;
		line-height: 16px;
	...
	:global(.classic-native-content) .catalog-details--plain th[scope='row'] {
