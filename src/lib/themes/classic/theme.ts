...
export type ClassicAssetKey =
	...
	| 'accountCharacterHidden'
	| 'accountStatusFree'
	| 'accountDownloadWindows'
	| 'accountBenefitTraining'
	| 'accountBenefitGuild'
	| 'accountBenefitSecurity'
	| 'background'
	| 'menuOrnament'
	| 'contentOrnament'
	| 'themeBoxOrnament'
	...
	| 'newsHeadlineIcon'
	| 'newsHeadlineIconServer'
	| 'newsHeadlineIconCommunity'
	| 'newsHeadlineIconDevelopment'
	| 'newsHeadlineIconSupport'
	| 'newsHeadlineIconTechnical'
	| 'premiumButtonDecor'
	| 'boxTop'
	| 'boxBottom'
	| 'boxHeader'
